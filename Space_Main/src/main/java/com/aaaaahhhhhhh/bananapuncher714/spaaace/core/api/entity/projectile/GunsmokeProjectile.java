package com.aaaaahhhhhhh.bananapuncher714.spaaace.core.api.entity.projectile;
...
import com.aaaaahhhhhhh.bananapuncher714.spaaace.core.api.events.projectile.GunsmokeProjectileHitBlockEvent;
import com.aaaaahhhhhhh.bananapuncher714.spaaace.core.api.events.projectile.GunsmokeProjectileHitEntityEvent;
import com.aaaaahhhhhhh.bananapuncher714.spaaace.core.api.events.projectile.GunsmokeProjectileHitEvent;
import com.aaaaahhhhhhh.bananapuncher714.spaaace.core.api.util.CollisionResultBlock;
import com.aaaaahhhhhhh.bananapuncher714.spaaace.core.api.util.CollisionResultEntity;
import com.aaaaahhhhhhh.bananapuncher714.spaaace.core.api.util.ProjectileTarget;
import com.aaaaahhhhhhh.bananapuncher714.spaaace.core.api.util.ProjectileTargetBlock;
import com.aaaaahhhhhhh.bananapuncher714.spaaace.core.api.util.ProjectileTargetEntity;
import com.aaaaahhhhhhh.bananapuncher714.spaaace.core.api.util.CollisionResult.CollisionType;
...
import com.aaaaahhhhhhh.bananapuncher714.spaaace.core.util.VectorUtil;
	...
	public EnumTickResult tick() {
		if ( getSpeed() > 0 ) {
			...
			for ( Entity entity : nearbyEntities ) {
				...
				Location originalPos = SpaceUtil.getPlugin().getLocationTracker().getLocationOf( entity.getUniqueId() );
				if ( originalPos == null ) {
					continue;
				}
			...
			List< CollisionResultBlock > collisions = SpaceUtil.rayTrace( location, getVelocity() );
			// For each collision...
