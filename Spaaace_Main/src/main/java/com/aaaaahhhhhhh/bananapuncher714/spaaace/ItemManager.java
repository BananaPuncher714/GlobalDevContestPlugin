...
import com.aaaaahhhhhhh.bananapuncher714.spaaace.api.GunsmokeEntityWrapperFactory;
import com.aaaaahhhhhhh.bananapuncher714.spaaace.api.GunsmokeRepresentable;
import com.aaaaahhhhhhh.bananapuncher714.spaaace.api.InteractableDamage;
import com.aaaaahhhhhhh.bananapuncher714.spaaace.api.RegenType;
import com.aaaaahhhhhhh.bananapuncher714.spaaace.api.Tickable;
...
import com.aaaaahhhhhhh.bananapuncher714.spaaace.api.events.entity.GunsmokeEntityUnloadEvent;
...
import com.aaaaahhhhhhh.bananapuncher714.spaaace.api.item.GunsmokeItemInteractable;
...
public class ItemManager implements Listener {
	...
	public ItemManager( Spaaace plugin ) {
		this.plugin = plugin;
	...
	private void onEvent( PlayerUpdateItemEvent event ) {
		...
		if ( newRepresentable instanceof GunsmokeItem ) {
			...
			GunsmokeEntity entity = getEntity( player.getUniqueId() );
