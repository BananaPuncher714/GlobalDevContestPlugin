package com.aaaaahhhhhhh.bananapuncher714.spaaace.implementation.world;
...
import com.aaaaahhhhhhh.bananapuncher714.spaaace.core.api.world.VoronoiNoiseGenerator;
import com.aaaaahhhhhhh.bananapuncher714.spaaace.core.util.Util;
...
public class SpaceGenerator extends ChunkGenerator {
	...
	static {
		...
		MATERIALS.put( Material.CYAN_TERRACOTTA, 1 );
		...
		CRATER_WALL_MATERIALS.put( Material.STONE, 5 );
		CRATER_WALL_MATERIALS.put( Material.CYAN_TERRACOTTA, 2 );
		CRATER_WALL_MATERIALS.put( Material.OBSIDIAN, 1 );
		CRATER_WALL_MATERIALS.put( Material.BLACK_TERRACOTTA, 2 );
		CRATER_WALL_MATERIALS.put( Material.GRAY_TERRACOTTA, 2 );
	}
				...
				if ( distSq > craterRadiusSquared ) {
					...
					for ( int i = 0; i < Math.max( height, craterFinHeight ); i++ ) {
						if ( i == 0 ) {
							...
							if ( i == ( int ) height ) {
								data.setBlock( x, i, z, Util.getRandom( SLABS ) );
							} else {
								data.setBlock( x, i, z, Util.getRandom( MATERIALS ) );
							}
						} else {
