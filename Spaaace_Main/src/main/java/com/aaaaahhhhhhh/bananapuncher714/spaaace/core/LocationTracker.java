...
/**
 * Track entities, and provide their location a certain amount of ticks in the past.
 * Used for calculating precise ray traces and stuff with lag.
 * 
...
public class LocationTracker {
	...
	public LocationTracker( SpaaaceCore plugin ) {
		this.plugin = plugin;
