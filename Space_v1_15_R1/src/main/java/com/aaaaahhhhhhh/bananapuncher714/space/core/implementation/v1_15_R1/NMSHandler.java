...
import com.aaaaahhhhhhh.bananapuncher714.space.core.api.sound.SoundSet;
import com.aaaaahhhhhhh.bananapuncher714.space.core.api.sound.SoundWave;
import com.aaaaahhhhhhh.bananapuncher714.space.core.api.tracking.GunsmokeEntityTracker;
...
public class NMSHandler implements PacketHandler {
	...
	@Override
	public void setPlugin( SpaceCore plugin ) {
		this.plugin = plugin;
	}
