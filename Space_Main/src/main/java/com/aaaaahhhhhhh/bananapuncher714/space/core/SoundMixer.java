...
import com.aaaaahhhhhhh.bananapuncher714.space.core.api.events.sound.PlaySoundEvent;
import com.aaaaahhhhhhh.bananapuncher714.space.core.api.sound.CompositeSound;
...
public class SoundMixer {
	...
	public static BukkitRunnable playSound( LocationTrackable location, double distance, CompositeSound sound, Runnable runAfter ) {
		...
		runnable.runTaskTimer( SpaceUtil.getPlugin(), 0, 1 );
