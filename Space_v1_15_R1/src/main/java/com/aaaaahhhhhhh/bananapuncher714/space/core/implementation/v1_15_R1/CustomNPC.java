...
import com.aaaaahhhhhhh.bananapuncher714.space.core.api.entity.npc.GunsmokeNPC;
import com.aaaaahhhhhhh.bananapuncher714.space.core.api.entity.npc.NPCAction;
...
public class CustomNPC extends EntityPlayer implements GunsmokeNPC {
	protected CustomNPC( World world, GameProfile profile ) {
		...
		SpaceUtil.getPlugin().getNPCManager().register( this );
	}
	
	protected CustomNPC( EntityTypes< ? extends EntityHuman > entitytypes, World world, String name ) {
...
//		move( EnumMoveType.PLAYER, new Vec3D( xDiff, yDiff, zDiff ) );
	...
	public void spawnFor( Player player ) {
		...
		if ( entityPlayer instanceof CustomNPC ) {
			return;
		} else {
			PacketPlayOutPlayerInfo addPlayer = new PacketPlayOutPlayerInfo( EnumPlayerInfoAction.ADD_PLAYER, this );
			PacketPlayOutNamedEntitySpawn spawnPlayer = new PacketPlayOutNamedEntitySpawn( this );
