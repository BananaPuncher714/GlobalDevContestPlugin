...
import com.aaaaahhhhhhh.bananapuncher714.space.core.api.tracking.VisibilityController;
...
public class CustomEntityTracker extends EntityTracker implements GunsmokeEntityTracker {
	...
	public GunsmokeEntityWrapper getEntity() {
		return SpaceUtil.getEntity( entity.getBukkitEntity() );
	}
	...
	public void updatePlayer( EntityPlayer player ) {
		...
		if ( controller != null ) {
			BooleanOption result = controller.isVisible( player.getBukkitEntity(), this );
			if ( result.isTrue() ) {
